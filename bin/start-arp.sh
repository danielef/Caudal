...
echo "Starting ARP from $ROOT_PATH"
export ARP_CONFIG=$(cat $ROOT_PATH/config/arp-config.edn)
echo "ARP_CONFIG : $ARP_CONFIG"

$JAVA_BIN -Djava.ext.dirs=lib mx.interware.arp.core.Starter
